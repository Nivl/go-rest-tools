...
// Source: github.com/Nivl/go-rest-tools/storage/filestorage (interfaces: Creator)
...
func (m *MockCreator) New() (filestorage.FileStorage, error) {
	ret := m.ctrl.Call(m, "New")
	ret0, _ := ret[0].(filestorage.FileStorage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
