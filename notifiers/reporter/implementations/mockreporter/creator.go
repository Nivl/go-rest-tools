...
// Source: github.com/Nivl/go-rest-tools/notifiers/reporter (interfaces: Creator)

// Package mockreporter is a generated GoMock package.
package mockreporter

import (
	reporter "github.com/Nivl/go-rest-tools/notifiers/reporter"
...
func (m *MockCreator) New() (reporter.Reporter, error) {
	ret := m.ctrl.Call(m, "New")
	ret0, _ := ret[0].(reporter.Reporter)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
